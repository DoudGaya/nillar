                    ...
                    howtoArticles.map( (single: HowTo) => {
                        return (
                            ...
                            <div className=" font-keisei bg-[#F7F7F7] dark:bg-stone-950 space-y-6  p-2 flex flex-col">
                                    <Link href={''} className='font-semibold text-sm  hover:underline'>{single.title}</Link>
                                    <div className="justify-between items-center text-sm flex ">
                                        <span>{ single._updatedAt }</span>
                                        <Link className=' dark:bg-stone-600 bg-primary-light text-white px-4 py-1' href={single.slug.current}>Learn More</Link>
                                    </div>
                            </div>
                        </div>
                    )
